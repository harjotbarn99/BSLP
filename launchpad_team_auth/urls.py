...
urlpatterns = [
    ...
    path('password-reset-confirm/<uidb64>/<token>/',
         PasswordResetConfirmView.as_view(template_name='launchpad_team_auth/passwordResetConfirm_LTA.html'),
...
# success_url=reverse_lazy("passwordResetConfirm-LTA") email_template_name='launchpad_team_auth/passwordResetEmail_LTA.html')